		...
		<div class="main-header">
			...
			<div class="logo-header" data-background-color="blue">
				...
				<a href="index.php" class="logo">
					<!-- <img src="../assets/img/teknik.png" alt="navbar brand" class="navbar-brand" width="40"> -->
		...
		<footer class="footer">
				<div class="container">
					<div class="copyright ml-auto">
						&copy; <?php echo date('Y');?> Absensi Siswa SMK AL-ITTIHAD RAAS (<a href="index.php">Fiqih Ardiansyah </a> | 2022)
					</div>				
				</div>
			</footer>
		</div>
