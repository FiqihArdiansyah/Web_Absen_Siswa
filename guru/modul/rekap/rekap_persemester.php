...
$tglTerakhir = 25;
 ...
 <table width="100%">
 	<tr>
 		<td>
 			<img src="../../../assets/img/teknik.png" width="130">
 		</td>
 		<td>
 			<center>
			 ...
			 <h1>
 					ABSESNSI SISWA <br>
 					<small>SMK AL-ITTIHAD RAAS</small>
 				</h1>
 				<hr>
 				<em>
 					Jl. Gampan Baru No 01 Desa ketupat Kecamatan Raas,<br> Kamang Kabupaten Sumenep, Provinsi Jwa Timur, Kode Pos (69485) <br>
 				<b>Email : smkalittihadraas@gmail.com Telp.085963090921</b> 
 				</em>
	...
	<!-- 	<td align="left">
		...
		<p>
			...
			<p>
				...
				<br>
				<br>
				Ach. Aden Ferdiansyah S.Pd M.Pd<br>
				-------------------------------<br>
